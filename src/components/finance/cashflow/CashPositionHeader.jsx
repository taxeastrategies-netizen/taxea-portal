    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-jakarta font-bold text-foreground tracking-tight">Cashflow Center</h1>
            <p className="text-sm text-muted-foreground mt-0.5">{company?.nombre_comercial || company?.razon_social || 'Tu empresa'}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            onClick={onRefresh}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-white border border-slate-200 shadow-sm text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all"
          >
            <RefreshCw className={cn("w-3.5 h-3.5", loading && "animate-spin")} />
            <span className="hidden sm:inline">Actualizar</span>
          </button>

          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-white border border-slate-200 shadow-sm text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
