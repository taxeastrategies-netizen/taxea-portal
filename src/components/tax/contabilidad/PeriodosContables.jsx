...
const CLOSING_CHECKS = [
  ...
  { id: '555', label: 'Partidas 555 clasificadas', passed: p => typeof p.pending555Balance === 'number' && Number.isFinite(p.pending555Balance) && Math.abs(p.pending555Balance) <= 0.01, detail: p => `${Number(p.pending555Balance || 0).toLocaleString('es-ES', { minimumFractionDigits: 2 })} €`, tab: 'conciliacion' },
