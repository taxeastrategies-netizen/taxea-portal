...
function evaluate(profile: any, activities: any[], body: any) {
  ...
  const taxKind = body.taxKind || activity.indirectJennTax || activity.indionarioTax || activity.indbotsTax || activity.indirectTax || profile.indirectTaxDefault || 'iva';
